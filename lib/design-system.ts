...
// Font families - centralized serif/sans options
export const fonts = {
  serif: "font-serif",
  serifStyle: { fontFamily: 'Georgia, serif' },
  sans: "font-sans",
}
...
export const typography = {
  ...
  heading: {
    h1: "text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight font-serif",
    h2: "text-2xl sm:text-3xl md:text-4xl font-semibold tracking-tight font-serif",
